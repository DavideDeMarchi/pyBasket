...
'''))
    ...
    def showThrows(self, *args):
        ...
        widget1,cards1 = self.board.game.playersList(self.board.game.players_by_number[:6], onclick=on_selected, single_line=False, show_info=True, one_line_if_less_than=0, w=playerw, initial_card_index=5)
        widget2,cards2 = self.board.game.playersList(self.board.game.players_by_number[6:], onclick=on_selected, single_line=False, show_info=True, one_line_if_less_than=4, w=playerw, initial_id=len(cards1), initial_card_index=11)
